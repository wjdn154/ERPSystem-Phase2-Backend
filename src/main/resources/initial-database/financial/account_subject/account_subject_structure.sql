...
('14', '수익', '매출', '매출', 1400, 1500,'NONE'),
('15', '비용', '매출원가', '매출원가', 1500, 1600,'NONE'),
('16', '비용', '제조원가', '제조원가', 1600, 1700,'NONE'),
('17', '비용', '도급원가', '도급원가', 1700, 1800,'NONE'),
('18', '비용', '보관원가', '보관원가', 1800, 1900,'NONE'),
('19', '비용', '분양원가', '분양원가', 1900, 2000,'NONE'),
('20', '비용', '운송원가', '운송원가', 2000, 2100,'NONE'),
('21', '비용', '판매관리비', '판매관리비', 2100, 2200,'NONE'),
('22', '수익', '영업외수익', '영업외수익', 2200, 2300,'NONE'),
('23', '비용', '영업외비용', '영업외비용', 2300, 2400,'NONE'),
('24', '비용', '법인세 (소득세)', '법인세', 2400, 2500,'NONE'),
