...
VALUES (1, 1, 0000000001, 30, '200mm', 1, 1), -- 엔진 오일 필터
    (2, 2, 0000000002, 40, '200mm', 1, 1), -- 엔진 오일 필터
    (3, 3, 0000000003, 50, '300mm', 2, 1), -- 브레이크 패드
    (4, 4, 0000000004, 60, '150mm', 3, 1), -- 연료 필터
    (5, 1, 0000000005, 90, '100mm', 4, 1), -- 점화 플러그
    (6, 5, 0000000006, 80, '250mm', 5, 2), -- 에어 필터
    (7, 6, 0000000007, 120, '1대', 6, 2), -- 알터네이터
    (8, 7, 0000000008, 150, '1개', 7, 2), -- 서스펜션 스프링
    (9, 8, 0000000009, 500, 'M사이즈', 8, 3), -- 배기 머플러
    (10, 9, 0000000010, 240, '1개', 9, 3), -- 디스크 로터
    (11, 10, 0000000011, 310, '1개', 10, 3), -- 와이퍼 블레이드
    (12, 12, 0000000012, 200, '1개', 11, 4), -- 라디에이터 캡
    (13, 13, 0000000013, 150, '180mm', 12, 4), -- 클러치 디스크
    (14, 13, 0000000014, 220, '1.2m', 13, 4), -- 타이밍 벨트
    (15, 14, 0000000015, 300, '600ml', 14, 6), -- 오일 펌프
    (16, 15, 0000000016, 120, '1세트', 15, 6), -- 브레이크 캘리퍼
    (17, 15, 0000000017, 200, '220mm', 16, 6), -- 브레이크 디스크
    (18, 16, 0000000018, 250, '300mm', 17, 7), -- ABS 모듈
    (19, 17, 0000000019, 150, '350mm', 18, 7), -- 냉각 팬
    (20, 17, 0000000020, 320, '150mm', 19, 7), -- 연료 펌프
    (21, 18, 0000000021, 180, '1개', 20, 8), -- 점화 코일
    (22, 19, 0000000022, 420, '2m', 21, 8), -- 배터리 케이블
    (23, 20, 0000000023, 600, '1개', 22, 9), -- 터보차저
    (24, 21, 0000000024, 550, '1개', 23, 9), -- 배기 가스 센서
    (25, 22, 0000000025, 350, '90mm', 24, 10), -- 서모스탯
    (26, 23, 0000000026, 450, '250mm', 25, 10), -- 핸들 조인트
    (27, 24, 0000000027, 200, '1.5m', 26, 12), -- 연료 레일
    (28, 25, 0000000028, 320, '400mm', 27, 12), -- 변속기 오일 팬
    (29, 26, 0000000029, 600, '1개', 28, 15), -- 스티어링 휠
    (30, 27, 0000000030, 900, '200mm', 29, 15), -- 워터 펌프
    (31, 28, 0000000031, 850, '1개', 30, 16), -- 라디에이터 호스
    (32, 29, 0000000032, 420, '2m', 31, 16), -- 브레이크 라인
    (33, 30, 0000000033, 300, '1개', 32, 18), -- 에어컨 압축기
    (34, 31, 0000000034, 720, '1개', 33, 18), -- 스태빌라이저 링크
    (35, 31, 0000000035, 180, '1개', 34, 18); -- 퓨즈 박스
