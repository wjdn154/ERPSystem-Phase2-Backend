...
import com.megazone.ERPSystem_phase2_Backend.production.model.work_performance.goods_receipt.enums.SerialNoStatus;
...
public class SerialNo {
    ...
    private SerialNoStatus serialNoStatus; // 상태 (예: '생산', '출고', '반품', '폐기' 등)


    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "lot_id", nullable = false)
    private Lot lot;               // 하나의 로트에 여러개의 시리얼 번호
