...
public interface UnresolvedVoucherRepository extends JpaRepository<UnresolvedVoucher, Long>, UnresolvedVoucherRepositoryCustom {
    ...
    List<UnresolvedVoucher> deleteAllByVoucherDateAndVoucherNumber(LocalDate date, String voucherNumber);
    List<UnresolvedVoucher> findAllByVoucherDateAndVoucherNumber(LocalDate date, String voucherNumber);
}
