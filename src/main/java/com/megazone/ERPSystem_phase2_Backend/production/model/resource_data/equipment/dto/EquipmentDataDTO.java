...
public class EquipmentDataDTO {
    ...
    private WorkcenterDTO workcenter;                //설비가 설치된 위치 or 구역 (작업장). 작업장 테이블 작업장 코드 참조
    private WarehouseDTO factory;               //설비가 설치된 공장 . 창고 테이블에 있는 공장코드 참조
    private String equipmentImg;                //설비 이미지



    public EquipmentData toEntity(Workcenter workcenter) {
        ...
        equipmentData.setModelName(modelName);
