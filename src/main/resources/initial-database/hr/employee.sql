...
INSERT INTO employee ( department_id, job_title_id, position_id, bankaccount_id,employee_number, first_name, last_name, date_of_birth, phone_number, employment_status, employment_type, email, address, hire_date, is_household_head, profile_picture) VALUES
    ( 1, 1, 1, 1,'0001', '김', '민성', '2000-07-20', '010-2512-9361', 'ACTIVE', 'INTERN', 'ckacl2512@naver.com', '부산', '2024-08-20', TRUE, 'x'),
 ( 2, 2, 2, 2,'0002' ,'홍', '성화', '2000-07-21', '010-2512-9361', 'ACTIVE', 'INTERN', 'ckacl2512@naver.com', '부산', '2024-08-20', TRUE, 'x'),
 ( 3, 3, 3, 3, '0003','허', '건호', '2000-07-22', '010-2512-9361', 'ACTIVE', 'INTERN', 'ckacl2512@naver.com', '부산', '2024-08-20', TRUE, 'x');
