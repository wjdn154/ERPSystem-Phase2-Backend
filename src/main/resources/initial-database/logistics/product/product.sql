...
('B0007', 8, 7, 6, 'GOODS', 80000, 100000, '원목 책상', '1개', 'SET', null, '가구/인테리어', TRUE),
('B0008', 9, 8, 2, 'GOODS', 25000, 30000, '기능성 재킷', 'M사이즈', 'EA', null, '의류', TRUE),
...
('B0011', 11, 1, 5, 'GOODS', 2000, 3000, '잡화 바구니', '1개', 'EA', null, '기타', TRUE),
