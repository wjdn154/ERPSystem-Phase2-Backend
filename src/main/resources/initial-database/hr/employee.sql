...
INSERT INTO employee (date_of_birth, hire_date, is_household_head, department_id, job_title_id, position_id, address, email, employee_number, first_name, last_name, phone_number, profile_picture, employment_status, employment_type)
VALUES
    ('1995-03-10', '2022-03-20', TRUE, 2, 1, 1, '대구', 'hshdla@naver.com', '20270910003', '홍스', '홍', '010-2234-5678', 'img3.jpg', 'ACTIVE', 'INTERN');

INSERT INTO employee (date_of_birth, hire_date, is_household_head, department_id, job_title_id, position_id, address, email, employee_number, first_name, last_name, phone_number, profile_picture, employment_status, employment_type)
VALUES
    ('1999-12-12', '2024-03-20', TRUE, 2, 1, 2, '부산', 'chlwlgur0407@naver.com', '20270910004', '지혁', '최', '010-2234-5678', 'img4.jpg', 'ACTIVE', 'INTERN');

INSERT INTO employee (date_of_birth, hire_date, is_household_head, department_id, job_title_id, position_id, address, email, employee_number, first_name, last_name, phone_number, profile_picture, employment_status, employment_type)
VALUES
    ('2000-01-01', '2022-03-20', TRUE, 2, 3, 1, '제주', 'cksals@naver.com', '20270910005', '찬민', '김', '010-2234-5678', 'img5.jpg', 'ACTIVE', 'INTERN');

INSERT INTO employee (date_of_birth, hire_date, is_household_head, department_id, job_title_id, position_id, address, email, employee_number, first_name, last_name, phone_number, profile_picture, employment_status, employment_type)
VALUES
    ('2000-10-16', '2024-12-13' , TRUE, 3, 2, 3, '거제', 'labe1827@gmail.com', '20270910006', '태종', '하', '010-2234-5678', 'img6.jpg', 'ACTIVE', 'INTERN');
